  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img className="" src={BG_IMAGE_URL} alt="Movie-logo" />
      </div>
      <form
        onSubmit={(e) => e.preventDefault()}
        className="w-full md:w-[27%] absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80"
      >
